...
<body class="left-txt">
    ...
    <div id="dashboard-navigation-panel" class="extra-small-width vertical-margin-50 fixed  z-30 right-0">
        ...
        <div id="view-posts-button" onclick="selectThisOverOther(this, 'dashboard-navigation-item'); hideAll('dashboard-panel');toggleThis('posts-panel');" class="dashboard-navigation-item extra-small-size center vertical-padding-15 center-txt"><img class="uninterupted-max-height" src='./assets/media/images/posts-icon.png'/></div>
